...
const HomePage = () => {
  return (
    <div className="container-fluid mb-2" style={{ backgroundColor: "grey" }}>
      <Carousel />
      <div className="container mt-5">
        <div className="row">
          <div className="col-md-8">
            <h1 className="text-color"style={{ color: "white" }}>Welcome to Turf Booking System</h1>
            <p>
          ...
          <div className="col-md-4">
            <img
              ...
              onMouseOver={(e) => {
                e.target.style.transform = "perspective(1000px) rotateX(0deg) rotateY(0deg) scale(1.05)";
                e.target.style.boxShadow = "15px 15px 30px rgba(0, 0, 0, 0.7)";
              }}
              onMouseOut={(e) => {
                e.target.style.transform = "perspective(1000px) rotateX(10deg) rotateY(-5deg)";
                e.target.style.boxShadow = "10px 10px 20px rgba(0, 0, 0, 0.5)";
              }}
            />
          </div>
        </div>
  ...
  onMouseOut={(e) => {
    ...
    e.target.style.boxShadow = "10px 10px 20px rgba(0, 0, 0, 0.5)";
          ...
          <div className="col-md-8">
            <h1 className="text-color ms-5"style={{ color: "white" }}>
